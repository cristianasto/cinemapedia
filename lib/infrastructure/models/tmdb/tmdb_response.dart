...
TmdbResponse tmdbNowPlayingResponseFromJson(String str) => TmdbResponse.fromJson(json.decode(str));

String tmdbNowPlayingResponseToJson(TmdbResponse data) => json.encode(data.toJson());
